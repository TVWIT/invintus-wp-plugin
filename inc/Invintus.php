...
class Invintus
{
  ...
  {
    if ( $post->post_type == $this->get_cpt_slug() && 'live' == $post_status ) return 'publish';
  ...
  public function maybe_allow_future_events( $post_status, $post )
  {
    ...
    if ( $post->post_type == $this->get_cpt_slug() && 'future' == $post_status ) return 'publish';
  ...
  public function register_custom_post_type()
  {
    ...
    $args = [
      ...
      'taxonomies'          => ['invintus_category', 'invintus_tag'],
      'hierarchical'        => false,
      'public'              => true,
      'show_ui'             => true,
      'show_in_menu'        => true,
